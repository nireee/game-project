...
public class NumberDial : MonoBehaviour
{
    ...
    void handleNumberPlacement()
    {
        ...
        for(int i = 0; i < Numbers.Length; i += 1)
        {
            ...
            if((i != 0 && i != 8 && yPos < NumbersDelta[i+1] && yPos > NumbersDelta[i-1]) || (i == 0 && (yPos > 0 && yPos < NumbersDelta[1] )) || (i == 8 && (yPos > NumbersDelta[7] || yPos < NumbersDelta[0])))
            //if (yPos <= NumbersDelta[i])
            {
                ...
                //if (currentIndex == 8 && yPos < NumbersDelta[7]) Numbers[0].localPosition = new Vector2(Numbers[0].localPosition.x, NumbersDelta[0] + NumbersDelta[8]);
                //else if (currentIndex == 0 && yPos > NumbersDelta[1]) Numbers[8].localPosition = new Vector2(Numbers[8].localPosition.x, 0);
